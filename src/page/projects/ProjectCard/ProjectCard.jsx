        ...
        >
            ...
            <div className='flex space-x-3'>
                <a
                    href={project?.live}
                    target='_blank'
                    className='flex-1 cursor-pointer py-2 px-4 text-center bg-black hover:bg-gray-800 text-white font-medium rounded-md 
                ...
                <a
                    href={project?.github}
                    target='_blank'
                    className='flex-1 py-2 px-4 cursor-pointer text-center bg-transparent hover:bg-gray-100 text-gray-800 font-medium rounded-md 
